...
const TemplateManagement: React.FC = () => {
  const [templates, setTemplates] = useState([
    {
      id: '1',
      template_name: 'Hero Banner Template',
      template_type: 'hero_banner',
      description: 'Large banner template for homepage and landing pages',
      default_styles: {
      ...
      required_fields: ['title', 'description', 'cta_text', 'cta_url'],
      is_active: true,
      created_at: '2024-01-01T00:00:00Z'
    },
    {
      id: '2',
      template_name: 'Promo Card Template',
      template_type: 'promo_card',
      description: 'Small promotional card for product highlights',
      default_styles: {
      ...
      required_fields: ['title', 'description', 'image_url', 'cta_text'],
      is_active: true,
      created_at: '2024-01-02T00:00:00Z'
    },
    {
      id: '3',
      template_name: 'Popup Modal Template',
      template_type: 'popup',
      description: 'Modal popup for announcements and offers',
      default_styles: {
            ...
            <div key={template.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    {template.is_active ? <X className="w-4 h-4" /> : <CheckCircle className="w-4 h-4" />}
                  </button>
                  <button
...
const TemplateForm: React.FC<TemplateFormProps> = ({ template, onSave, onCancel }) => {
  const [formData, setFormData] = useState({
    ...
    template_type: template?.template_type || 'hero_banner',
