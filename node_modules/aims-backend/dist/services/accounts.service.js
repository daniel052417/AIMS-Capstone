...
class AccountsService {
    ...
    static async getGLTransactions(filters = {}) {
        try {
            let query = supabaseClient_1.supabaseAdmin
    ...
    static async getGLTransactionById(id) {
        try {
            const { data, error } = await supabaseClient_1.supabaseAdmin
                .from('gl_transactions')
                .select(`
    ...
    static async createGLTransaction(transactionData, items) {
        try {
            const { data: transaction, error: transactionError } = await supabaseClient_1.supabaseAdmin
                .from('gl_transactions')
            ...
            const { data: transactionItems, error: itemsError } = await supabaseClient_1.supabaseAdmin
    ...
    static async postGLTransaction(id, postedByUserId) {
        try {
            const { data, error } = await supabaseClient_1.supabaseAdmin
                .from('gl_transactions')
                .update({
    ...
    static async approveExpense(id, approvedByUserId) {
        try {
            const { data, error } = await supabaseClient_1.supabaseAdmin
                .from('expenses')
                .update({
    ...
    static async getBalanceSheet(filters = {}) {
        try {
            const { data, error } = await supabaseClient_1.supabaseAdmin
