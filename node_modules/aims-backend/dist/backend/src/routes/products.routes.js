...
router.get('/', (0, auth_1.requireRole)(['super_admin', 'inventory_admin', 'inventory_clerk', 'pos_cashier']), (0, errorHandler_1.asyncHandler)(productsController.getProducts));
router.get('/:id', (0, auth_1.requireRole)(['super_admin', 'inventory_admin', 'inventory_clerk', 'pos_cashier']), (0, errorHandler_1.asyncHandler)(productsController.getProductById));
router.post('/', (0, auth_1.requireRole)(['super_admin', 'inventory_admin']), (0, errorHandler_1.asyncHandler)(productsController.createProduct));
router.put('/:id', (0, auth_1.requireRole)(['super_admin', 'inventory_admin']), (0, errorHandler_1.asyncHandler)(productsController.updateProduct));
router.delete('/:id', (0, auth_1.requireRole)(['super_admin', 'inventory_admin']), (0, errorHandler_1.asyncHandler)(productsController.deleteProduct));
...
router.post('/:productId/adjust-stock', (0, auth_1.requireRole)(['super_admin', 'inventory_admin', 'inventory_clerk']), (0, errorHandler_1.asyncHandler)(productsController.adjustStock));
