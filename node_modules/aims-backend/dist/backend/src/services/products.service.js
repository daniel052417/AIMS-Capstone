...
class ProductsService {
    ...
    static async updateInventoryLevel(id, levelData) {
        try {
            const { data, error } = await supabaseClient_1.supabaseAdmin
                .from('inventory_levels')
                .update(levelData)
    ...
    static async createInventoryMovement(movementData) {
        try {
            const { data, error } = await supabaseClient_1.supabaseAdmin
                .from('inventory_movements')
                .insert([movementData])
    ...
    static async adjustStock(productId, quantity, movementType, notes, createdByUserId) {
        try {
            const movementData = {
